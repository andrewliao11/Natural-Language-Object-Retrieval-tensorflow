...
GPU_ID=$1
WEIGHTS=\
/home/ronghang/workspace/open-voc-obj-retriv/imagenet/caffemodel/finetune_vgg_7k_iter_20000.caffemodel
...
./build/tools/caffe train \
    -solver ./examples/coco_caption/lrcn_solver.vgg_7k.prototxt \
    -weights $WEIGHTS \
    -gpu $GPU_ID
